...
export const Navbar = () => {
  ...
  return (
    <motion.nav 
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="fixed top-0 left-0 right-0 z-40 bg-[#FFA036]/90 backdrop-blur-lg border-b border-black/20 h-18"
    >
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button
              ...
              className="text-black hover:text-black/70 transition-colors font-doggie text-xl underline"
            >
              <u>how to play?</u>
            </button>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-2 rounded-full bg-[#FD8700] hover:bg-[#FD8700]/80 
